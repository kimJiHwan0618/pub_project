    ...
    <div class="header_inner" ref="header">
      ...
      <div class="header_bottom">
        <div>
          ...
          <nuxt-link to="/"><img class="logo" src="@/assets/images/logo.png" alt="Logo"></nuxt-link>
        </div>
        <nav class="gnb" ref="gnb">
          <ul>
            <li>
              <nuxt-link class="main_list" to="/">HOME</nuxt-link>
              <ul class="sub_menu">
            ...
            <li>
              <nuxt-link class="main_list" to="/product-all">PRODUCTS</nuxt-link>
              <ul class="sub_menu">
        ...
        <ul class="icon_wrap">
          <li><nuxt-link to="/my-account"><i class="fas fa-user"></i></nuxt-link></li>
          ...
          >
            ...
            <ul class="shoplist_wrap">
              ...
              <li class="shop_list">
                ...
                <span class="shopview_btn"><nuxt-link to="/checkout-cart/step1">View Cart</nuxt-link></span>
              </li>
            </ul>
          </li>
        </ul>
