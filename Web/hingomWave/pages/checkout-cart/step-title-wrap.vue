...
export default {
  ...
  data () {
    return {
      stepTitle : [
        { title : 'Delivery Options', explanation : 'Lorem ipsum dolor sit amet.', num : '1', step : '/checkout-cart/step1'},
        { title : 'Shipping Address', explanation : 'Vivamus eleifend euismod.', num : '2', step : '/checkout-cart/step2'},
        { title : 'Payment', explanation : 'Aenean ut pretium ipsum.', num : '3', step : '/checkout-cart/step3'},
        { title : 'Complete Payment', explanation : 'Curabitur interdum libero.', num : '4', step : '/checkout-cart/step4'}
      ]
    }
  },
  mounted () {
